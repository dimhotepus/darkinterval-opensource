...
void DrawFlesh_Internal(CBaseVSShader *pShader, IMaterialVar** params, IShaderDynamicAPI *pShaderAPI,
	IShaderShadow* pShaderShadow, bool bHasFlashlight, FleshVars_t &info, VertexCompressionType_t vertexCompression);
