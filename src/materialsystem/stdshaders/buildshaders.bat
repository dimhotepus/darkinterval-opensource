...
set TTEXE=..\..\materialsystem\devtools\timeprecise.exe
...
set DIRECTX_SDK_BIN_DIR=materialsystem\dx9sdk\utilities

if /i "%6" == "-dx9_30" goto dx_sdk_dx9_30
goto dx_sdk_end
:dx_sdk_dx9_30
			set DIRECTX_SDK_VER=pc09.30
			set DIRECTX_SDK_BIN_DIR=materialsystem\dx10sdk\utilities\dx9_30
			goto dx_sdk_end
:dx_sdk_end
