...
//#   if OUTLINE // ifndef DARKINTERVAL - thrown out
...
//#   if SOFTEDGES // ifndef DARKINTERVAL - thrown out
...
struct PS_INPUT
{
	...
	// ifdef DARKINTERVAL
	HALF4 detailOrBumpAndEnvmapMaskTexCoord : TEXCOORD1;   // envmap mask
	// endif
...
// ssbump
	...
	// DI todo - why was this removed? did this mess up parallax corrected surfaces under flashlight?
#if 0 // ifndef DARKINTERVAL
	...
	if( bCubemap )
	{
		...
		//cubemap darkened by lightmap mode
		//reduce the cubemap contribution when the pixel is in shadow.
		specularLighting = lerp( specularLighting, specularLighting * saturate( diffuseLighting ), 0.8f ); 
#endif
		// endif // DARKINTERVAL
