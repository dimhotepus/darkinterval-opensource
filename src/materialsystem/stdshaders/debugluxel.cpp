...
#ifdef DARKINTERVAL // The NEW shader is broken on HDR. Undefining it fixes luxel density preview in HDR mode 
					// (the debug VMT in the mod needs to thus use DI_DebugLuxels shader).
#undef USE_NEW_SHADER
#else
...
#ifdef DARKINTERVAL
BEGIN_SHADER_FLAGS(DI_DebugLuxels, "Help for DebugLuxels", SHADER_NOT_EDITABLE)
