...
ConVar mat_dof_max_blur_radius( "mat_dof_max_blur_radius", "99" );
ConVar mat_dof_blur_threshold("mat_dof_blur_threshold", "1.0");
...
BEGIN_VS_SHADER_FLAGS( DepthOfField_dx9, "Depth of Field", SHADER_NOT_EDITABLE )
	BEGIN_SHADER_PARAMS
		...
		SHADER_PARAM( QUALITY, SHADER_PARAM_TYPE_INTEGER, "3", "Quality level. Selects different algorithms." )
	END_SHADER_PARAMS
	...
	SHADER_DRAW
	{
		...
		DYNAMIC_STATE
		{
			...
			vConst[7] = mat_dof_blur_threshold.GetFloat();
