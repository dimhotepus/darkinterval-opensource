...
#define	GAME_CONFIG_FILENAME	"level_editor\\cfg\\GameConfig.cfg" //// SLE CHANGE - relocate the game config files
#define DEFAULT_GAME_CONFIG_FILENAME "level_editor\\cfg\\GameConfig_default.cfg"
#define TOKEN_SDK_VERSION		"SDKVersion"
...
bool CGameConfigManager::LoadConfigsInternal(const char *baseDir)
{
	...
	if (!m_pData->LoadFromFile(g_pFullFileSystem, GAME_CONFIG_FILENAME, "level_editor_cfg"))
	{
...
bool CGameConfigManager::CreateDefaultConfig(void)
{
	...
	configBlock->SaveToFile(g_pFullFileSystem, GAME_CONFIG_FILENAME, "level_editor_cfg");
...
bool CGameConfigManager::SaveConfigs(const char *baseDir)
{
	...
	return m_pData->SaveToFile(g_pFullFileSystem, GAME_CONFIG_FILENAME, "level_editor_cfg");
}
...
bool CGameConfigManager::ResetConfigs(const char *baseDir /*= NULL*/)
{
	...
	// Delete the file
	g_pFullFileSystem->RemoveFile(GAME_CONFIG_FILENAME, "level_editor_cfg");
	if (g_pFullFileSystem->FileExists(GAME_CONFIG_FILENAME, "level_editor_cfg"))
		return false;
...
bool CGameConfigManager::GetDefaultGameBlock(KeyValues *pIn)
{
	return pIn->LoadFromFile(g_pFullFileSystem, DEFAULT_GAME_CONFIG_FILENAME, "level_editor_cfg");
}
