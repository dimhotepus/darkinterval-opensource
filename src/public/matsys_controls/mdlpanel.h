...
//	void SetThumbnailSafeZone( bool bVisible ); //// SLE REMOVE - making model browser leaner
	void SetShowAllAttachments(bool bShow); //// SLE NEW - attachments tab
	void SetSelectedAttachmentId(int id);
...
//	bool	m_bThumbnailSafeZone : 1; //// SLE REMOVE - making model browser leaner
	bool	m_bShowAllAttachments : 1; //// SLE NEW - attachments tab
	int		m_nSelectedAttachment; 
