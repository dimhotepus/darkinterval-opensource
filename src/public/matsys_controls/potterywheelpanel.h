...
public:
	...
	virtual void ApplySettings(KeyValues *inResourceData); //// SLE NEW - backports for matsys_controls
	virtual void Init( int x, int y, int wide, int tall );
	virtual void Paint();

	virtual void OnKeyCodePressed ( vgui::KeyCode code );
	virtual void OnKeyCodeReleased( vgui::KeyCode code );
	virtual void OnMouseDoublePressed(vgui::MouseCode code); //// SLE NEW - backports for matsys_controls
	...
	void SetGridColor(int r, int g, int b); //// SLE NEW - backports for matsys_controls
	...
	virtual void ResetView(); //// SLE NEW - backports for matsys_controls

	// Allow the parent to be notified of mouse actions
	void SetParentMouseNotify(bool bParentMouseNotify); //// SLE NEW - backports for matsys_controls
...
private:
	...
	void DestroyLights();
	void ParseLightsFromKV(KeyValues *pLightsKV); //// SLE NEW - backports for matsys_controls
	...
	Color m_ClearColor;
	Color m_GridColor; //// SLE NEW - backports for matsys_controls
	...
	bool    m_bParentMouseNotify : 1; //// SLE NEW - backports for matsys_controls
