...
public:
	...
	enum PageType_t
	{
		...
		PAGE_SKINS			= 0x8,
		PAGE_INFO			= 0x10,
		PAGE_ATTACHMENTS	= 0x20, //// SLE NEW - attachments tab
		PAGE_ALL			= 0xFFFFFFFF,
	};
...
private:
	...
	int	 UpdateSkinsList();
	void UpdateInfoTab();
	void UpdateAttachmentsTab(); //// SLE NEW - attachments tab
...
//	MESSAGE_FUNC_CHARPTR( OnDirectorySelected, "DirectorySelected", dir );
	...
	vgui::PropertyPage *m_pAttachmentsPage; //// SLE NEW - attachments tab
	...
	vgui::ListPanel *m_pAttachmentsList; //// SLE NEW - attachments tab

//	vgui::ListPanel	*m_pLodsList; //// SLE NEW - extended model browser
