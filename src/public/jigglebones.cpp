...
ConVar cl_jiggle_bone_framerate_cutoff( "cl_jiggle_bone_framerate_cutoff", "30", 0, "Skip jiggle bone simulation if framerate drops below this value (frames/second)" );
