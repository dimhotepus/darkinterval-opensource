...
Vector CThirdPersonManager::GetDistanceFraction( void )
{
	...
	float flFrac = RemapValClamped( CURTIME - m_flLerpTime, 0, CAMERA_OFFSET_LERP_TIME, 0, 1 );
	...
	flFrac = RemapValClamped( CURTIME - m_flUpLerpTime, 0, CAMERA_UP_OFFSET_LERP_TIME, 0, 1 );
