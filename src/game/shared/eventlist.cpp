...
#ifdef DARKINTERVAL
	REGISTER_SHARED_ANIMEVENT( AE_NPC_OPEN_DOOR_AWAY, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT( AE_NPC_OPEN_DOOR_TOWARDS_LEFT, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT( AE_NPC_OPEN_DOOR_TOWARDS_RIGHT, AE_TYPE_SERVER);
	REGISTER_SHARED_ANIMEVENT(AE_CL_CREATE_DLIGHT, AE_TYPE_CLIENT);
#endif
}