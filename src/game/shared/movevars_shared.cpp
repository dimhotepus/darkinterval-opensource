...
ConVar	sv_rollangle	( "sv_rollangle", "0.6", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_ARCHIVE);
...
ConVar	sv_skyname		( "sv_skyname", "neb7", FCVAR_ARCHIVE | FCVAR_REPLICATED, "Current name of the skybox texture" );
#else
...
ConVar	sv_rollangle	("sv_rollangle", "0.6", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "Max view roll angle");
