...
#ifdef DARKINTERVAL
#define WEAPON_ALTFIRE_HUD_HINT_COUNT	2 // DI CHANGE
#define WEAPON_RELOAD_HUD_HINT_COUNT	0
#else
...
#ifdef DARKINTERVAL // extra degree macroses in case they come in handy.
#define VECTOR_CONE_25DEGREES		Vector( 0.21644, 0.21644, 0.21644 )
#define VECTOR_CONE_30DEGREES		Vector( 0.25882, 0.25882, 0.25882 )
#define VECTOR_CONE_35DEGREES		Vector( 0.30070, 0.30070, 0.30070 )
#define VECTOR_CONE_40DEGREES		Vector( 0.34202, 0.34202, 0.34202 )
#define VECTOR_CONE_45DEGREES		Vector( 0.38268, 0.38268, 0.38268 )
#endif
//-----------------------------------------------------------------------------
...
#ifdef DARKINTERVAL
	virtual void			BreakWeapon(void) {	}; // was used in really old DI demos, for breaking the currently held weapon (stunstick at Industrial).
#endif
...
#ifdef DARKINTERVAL
	virtual int				GetZoomType(void) const;
#endif
...
public:
	...
	bool					m_can_fire_underwater_boolean;		// true if this weapon can fire underwater
	bool					m_can_altfire_underwater_boolean;		// true if this weapon can fire underwater
	...
	bool					m_reloads_singly_boolean;		// True if this weapon reloads 1 round at a time
