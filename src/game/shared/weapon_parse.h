...
#ifdef DARKINTERVAL // weapon zoom has been married to suit zoom, and is defined in the weapon script file
enum
{
	ZOOM_DISABLED = -1,
	ZOOM_NAKEDEYE,
...
#ifdef DARKINTERVAL
	int						iZoomType;// weapon zoom has been married to suit zoom, and is defined in the weapon script file							
#endif
	//
	// Sound blocks
