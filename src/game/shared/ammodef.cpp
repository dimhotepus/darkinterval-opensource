...
// Output :
//-----------------------------------------------------------------------------
float	CAmmoDef::ArmorMitigation(int nAmmoIndex)
{
	if (nAmmoIndex < 1 || nAmmoIndex >= m_nAmmoIndex)
		return 1.0f;

	return m_AmmoType[nAmmoIndex].flArmorMitigation;
}
#endif
//-----------------------------------------------------------------------------
// Purpose:
...
//-----------------------------------------------------------------------------
#ifdef DARKINTERVAL
bool CAmmoDef::AddAmmoType(char const* name, int damageType, int tracerType, int nFlags, int minSplashSize, int maxSplashSize, float flArmorMitigation)
#else
...
#ifdef DARKINTERVAL
	m_AmmoType[m_nAmmoIndex].flArmorMitigation = flArmorMitigation;
#endif
...
void CAmmoDef::AddAmmoType(char const* name, int damageType, int tracerType, 
	...
	float physicsForceImpulse, int nFlags, int minSplashSize, int maxSplashSize, float flArmorMitigation)
#else
void CAmmoDef::AddAmmoType(char const* name, int damageType, int tracerType,
	char const* plr_cvar, char const* npc_cvar, char const* carry_cvar,
...
{
#ifdef DARKINTERVAL
	if ( AddAmmoType( name, damageType, tracerType, nFlags, minSplashSize, maxSplashSize, flArmorMitigation ) == false )
#else
...
void CAmmoDef::AddAmmoType(char const* name, int damageType, int tracerType, 
	...
	int nFlags, int minSplashSize, int maxSplashSize, float flArmorMitigation )
#else
void CAmmoDef::AddAmmoType(char const* name, int damageType, int tracerType,
	int plr_dmg, int npc_dmg, int carry, float physicsForceImpulse,
