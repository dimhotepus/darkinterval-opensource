...
#define LOCATOR_UPDATE_FREQUENCY 0.5f
#define LOCATOR_UPDATE_FREQUENCY_FAST	0.1f

enum // If we have more than 16 types of contacts, LOCATOR_CONTACT_TYPE_BITS
{
	LOCATOR_CONTACT_NONE = -1,
	LOCATOR_CONTACT_POINT_OF_INTEREST = 0,
	LOCATOR_CONTACT_OUTPOST,
	LOCATOR_CONTACT_MAIN_OBJECTIVE,
