...
#ifdef DARKINTERVAL // extra cone macroses, could come in handy
#define CONE_5_DEGREES		0.9961947f
#define CONE_10_DEGREES		0.984808f
#endif
...
#ifdef DARKINTERVAL // todo: not used anywhere?
#define PLACE_PLAYER_FOOTPRINT 3
#endif
