...
//-----------------------------------------------------------------------------
#ifdef DARKINTERVAL
inline CHL2_Player	*CPortalGameMovement::GetPortalPlayer()
{
...
#ifdef DARKINTERVAL
	m_bInPortalEnv = (((CHL2_Player *)pPlayer)->m_hPortalEnvironment != NULL);
#else
...
bool CPortalGameMovement::CheckJumpButton()
{
	...
	{
#ifndef DARKINTERVAL // todo - fix/add
...
#ifdef DARKINTERVAL
	CHL2_Player *pPlayer = GetPortalPlayer();
#else
...
#ifdef DARKINTERVAL
	CHL2_Player *pPortalPlayer = dynamic_cast<CHL2_Player *>(player->GetRefEHandle().Get());
#else
...
int CPortalGameMovement::CheckStuck( void )
{
	...
	{
#ifdef DARKINTERVAL
		CHL2_Player *pPortalPlayer = GetPortalPlayer();
#else
...
#ifdef DARKINTERVAL
	CHL2_Player *pPortalPlayer = (CHL2_Player *)((CBaseEntity *)mv->m_nPlayerHandle.Get());
#else
