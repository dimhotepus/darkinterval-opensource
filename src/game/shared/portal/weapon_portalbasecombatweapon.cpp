...
bool CBasePortalCombatWeapon::Deploy( void )
{
	...
	{
		CHL2_Player *pPlayer = ToHL2Player(GetOwner()); // assert_cast<CHL2_Player*>(GetOwner());
...
static ConVar	v_iyaw_cycle( "v_iyaw_cycle", "2", FCVAR_REPLICATED );
static ConVar	v_iroll_cycle( "v_iroll_cycle", "0.5", FCVAR_REPLICATED );
static ConVar	v_ipitch_cycle( "v_ipitch_cycle", "1", FCVAR_REPLICATED );
static ConVar	v_iyaw_level( "v_iyaw_level", "0.3", FCVAR_REPLICATED );
static ConVar	v_iroll_level( "v_iroll_level", "0.1", FCVAR_REPLICATED );
static ConVar	v_ipitch_level( "v_ipitch_level", "0.3", FCVAR_REPLICATED );
