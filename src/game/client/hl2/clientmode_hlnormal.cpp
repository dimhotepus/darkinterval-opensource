//========================================================================//
//
// Purpose: Draws the normal HL2 HUD.
//
//=============================================================================
#include "cbase.h"
...
#ifdef DARKINTERVAL
ConVar fov_desired( "fov_desired", "75", FCVAR_ARCHIVE | FCVAR_USERINFO, "Sets the base field-of-view.", true, 45.0, true, 150.0 );
#else
...
/*
	...
	if (gameUIFactory)
	{
		...
		if (NULL != m_pGameUI)
		{
			// DI NEW: add this custom dialogue as loading background for client
