...
#ifdef DARKINTERVAL
	{ "HudTakeDamageAcid",		DMG_ACID,		ANGLE_ANY,	ANGLE_ANY,	DAMAGE_ANY },
	{ "HudTakeDamageFreeze",	DMG_FREEZE,		ANGLE_ANY,	ANGLE_ANY,	DAMAGE_ANY },
#endif
...
#ifndef DARKINTERVAL // DI change: remove this. It creates annoying big red fade when we're fighint enemies in the first chapters. 
