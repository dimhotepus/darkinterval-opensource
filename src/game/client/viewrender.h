...
private:
	...
	bool			DrawOneMonitor(ITexture *pRenderTarget, int cameraNum, C_PointCamera *pCameraEnt, 
		const CViewSetup &cameraView, C_BasePlayer *localPlayer,
		int x, int y, int width, int height);
#ifdef DARKINTERVAL
	void			DrawDIWaterReflection(const CViewSetup &viewSet);
#endif
	// Drawing primitives
