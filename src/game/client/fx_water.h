...
extern void FX_WaterRipple( const Vector &origin, float scale, Vector *pColor, float flLifetime=1.5, float flAlpha=1, bool bBumpMapped = false );
extern void FX_GunshotSplash( const Vector &origin, const Vector &normal, float scale, bool bBumpMapped = false, bool bPlaySound = true);
extern void FX_GunshotSlimeSplash( const Vector &origin, const Vector &normal, float scale, bool bBumpMapped = false, bool bPlaySound = true);
