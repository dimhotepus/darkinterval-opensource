...
class IGenericMenuScroller : public vgui::Frame, public CAutoGameSystem
{
	DECLARE_CLASS_SIMPLE(IGenericMenuScroller, vgui::Frame);

	IGenericMenuScroller(vgui::VPANEL parent, const char *title);
