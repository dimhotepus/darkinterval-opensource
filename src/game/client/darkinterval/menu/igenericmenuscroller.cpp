...
IGenericMenuScroller::IGenericMenuScroller(vgui::VPANEL parent, const char *title) : BaseClass(NULL, "IGenericMenuSlideyScrollPanel")
{
	SetTitle(title, true);
	SetParent(parent);
	...
	m_pScrollControl = new vgui::Panel(this, "IGenericMenuSlideyScrollPanelScroller");

	m_pUpButton = new vgui::Button(this, "IGenericMenuSlideyScrollPanelUp", "UP", this, SCROLL_UP_COMMAND);
	m_pUpButton->SetContentAlignment(vgui::Label::a_center);

	m_pDownButton = new vgui::Button(this, "IGenericMenuSlideyScrollPanelDown", "DOWN", this, SCROLL_DOWN_COMMAND);
...
void IGenericMenuScroller::LayoutItems()
{
...
void IGenericMenuScroller::ClearItems()
{
	for (int i = 0; i < m_pItems.Count(); i++)
	{
		vgui::Panel *item = m_pItems.Element(i);
...
void IGenericMenuScroller::AddItem(vgui::Panel *item)
{
...
void IGenericMenuScroller::OnThink()
{
...
void IGenericMenuScroller::PerformLayout()
{
...
void IGenericMenuScroller::AddToScroller(int amount)
{
...
void IGenericMenuScroller::OnCommand(const char *command)
{
...
void IGenericMenuScroller::OnMouseWheeled(int delta)
{
