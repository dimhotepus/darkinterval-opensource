...
#include "../common/xbox/xboxstubs.h" // DI TODO: get rid of this trash
...
void CInput::Joystick_Advanced(void)
{
	...
	else
	{
		if ( Q_stricmp( joy_name.GetString(), "joystick") != 0 )
		{
			...
			DevMsg( "Using joystick '%s' configuration\n", joy_name.GetString() );
		}
		...
		DevMsg( "Advanced Joystick settings initialized\n" );
	}
