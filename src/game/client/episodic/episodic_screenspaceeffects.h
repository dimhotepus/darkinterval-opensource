...
#ifdef DARKINTERVAL
//
//  DI Stinger Spit Venom Effect
//

class CDIStingerEffect : public IScreenSpaceEffect
{
public:
	CDIStingerEffect(void) :
		m_flDuration(0.0f),
		m_flFinishTime(0.0f),
		m_bUpdateView(true),
		m_bEnabled(false),
...
ADD_SCREENSPACE_EFFECT(CDIStingerEffect, di_stinger_venom);

class CDIStingerEffectB : public IScreenSpaceEffect
{
public:
	CDIStingerEffectB(void) :
		m_flDuration(0.0f),
		m_flFinishTime(0.0f),
		m_bUpdateView(true),
		m_bEnabled(false),
...
ADD_SCREENSPACE_EFFECT(CDIStingerEffectB, di_stinger_background);
#endif // DARKINTERVAL
