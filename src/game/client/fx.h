...
#ifdef DARKINTERVAL
void FX_GlassImpact(const Vector &position, const Vector &normal);
#endif
...
#ifdef DARKINTERVAL
void FX_GenericBulletTracer(Vector& start, Vector& end, int velocity, bool makeWhiz = true);
void FX_TurretTracer(Vector& start, Vector& end, int velocity, bool makeWhiz = true);
#endif
