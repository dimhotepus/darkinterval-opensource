...
static ConVar cam_command( "cam_command", "0", 0 /*FCVAR_NONE */);	 // tells camera to go to thirdperson
static ConVar cam_snapto( "cam_snapto", "0", 0 /*FCVAR_ARCHIVE */);	 // snap to thirdperson view
static ConVar cam_ideallag( "cam_ideallag", "4.0", 0 /*FCVAR_ARCHIVE */, "Amount of lag used when matching offset to ideal angles in thirdperson view" );
static ConVar cam_idealdelta( "cam_idealdelta", "4.0", 0 /*FCVAR_ARCHIVE */, "Controls the speed when matching offset to ideal angles in thirdperson view" );
ConVar cam_idealyaw( "cam_idealyaw", "0", 0 /*FCVAR_ARCHIVE */ );	 // thirdperson yaw
ConVar cam_idealpitch( "cam_idealpitch", "0", 0 /*FCVAR_ARCHIVE */ );	 // thirperson pitch
ConVar cam_idealdist( "cam_idealdist", "150", 0 /*FCVAR_ARCHIVE */ );	 // thirdperson distance
ConVar cam_idealdistright( "cam_idealdistright", "0", 0 /*FCVAR_ARCHIVE */ );	 // thirdperson distance
ConVar cam_idealdistup( "cam_idealdistup", "0", 0 /*FCVAR_ARCHIVE */ );	 // thirdperson distance
static ConVar cam_collision( "cam_collision", "1", 0 /*FCVAR_ARCHIV */, "When in thirdperson and cam_collision is set to 1, an attempt is made to keep the camera from passing though walls." );
static ConVar cam_showangles( "cam_showangles", "0", 0, /*FCVAR_NONE,*/ "When in thirdperson, print viewangles/idealangles/cameraoffsets to the console." );
static ConVar c_maxpitch( "c_maxpitch", "90", 0 /*FCVAR_ARCHIVE */ );
static ConVar c_minpitch( "c_minpitch", "0", 0 /*FCVAR_ARCHIVE */ );
static ConVar c_maxyaw( "c_maxyaw",   "135", 0 /*FCVAR_ARCHIVE */ );
static ConVar c_minyaw( "c_minyaw",   "-135", 0 /*FCVAR_ARCHIVE */ );
static ConVar c_maxdistance( "c_maxdistance",   "200", 0 /*FCVAR_ARCHIVE */ );
static ConVar c_mindistance( "c_mindistance",   "30", 0 /*FCVAR_ARCHIVE */ );
static ConVar c_orthowidth( "c_orthowidth",   "100", 0 /*FCVAR_ARCHIVE T*/ );
static ConVar c_orthoheight( "c_orthoheight",   "100", 0 /*FCVAR_ARCHIVE */ );
...
void CInput::CAM_Think( void )
{
	...
	else
	{
		...
		if (abs(camOffset[DIST] - cam_idealdist.GetFloat()) < 2.0f)
			camOffset[DIST] = cam_idealdist.GetFloat();
		else
