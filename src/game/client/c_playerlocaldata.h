...
public:
	...
	bool					m_bWearingLongJump;
	bool					m_bPlayingArcade;
	bool					m_bPlayingArcadeAsManhack;
	bool					m_bLocatorVisible;
	bool					m_bSuitlessHUDVisible;
	float					m_WeaponProxyValueSlot01_float;
	float					m_WeaponProxyValueSlot02_float;
	float					m_WeaponProxyValueSlot03_float;
	float					m_WeaponProxyValueSlot04_float;
	float					m_WeaponProxyValueSlot05_float;
	float					m_WeaponProxyValueSlot06_float;
	float					m_WeaponProxyValueSlot07_float;
	float					m_WeaponProxyValueSlot08_float;
#endif	////////////////////////////////////////////
	bool					m_bPoisoned;
#ifdef DARKINTERVAL
	bool					m_bParalyzed;
