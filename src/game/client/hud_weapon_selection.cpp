...
{
	s_pInstance = this;
#ifdef DARKINTERVALL // DI allows weapon selection in worker suit
...
#ifndef DARKINTERVAL // allowed for convenience and players without either HEV nor worker suit
