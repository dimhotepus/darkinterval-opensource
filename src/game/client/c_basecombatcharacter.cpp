...
{
#ifdef DARKINTERVAL
	*r = di_glow_color_r.GetFloat();//0.76f;
	*g = di_glow_color_g.GetFloat();//0.76f;
	*b = di_glow_color_b.GetFloat();//0.76f;
#else
	*r = 0.76f;
	*g = 0.76f;
	*b = 0.76f;
...
#ifdef DARKINTERVAL
	RecvPropFloat(RECVINFO(m_fGlowColorRed)),
	RecvPropFloat(RECVINFO(m_fGlowColorGreen)),
	RecvPropFloat(RECVINFO(m_fGlowColorBlue)),
#endif
#endif // GLOWS_ENABLE
