...
public:
...
#ifdef DARKINTERVAL	// DI
	bool			IsLongJumpEquipped(void) { return m_Local.m_bWearingLongJump; };
	bool			IsPlayingArcade(void) { return m_Local.m_bPlayingArcade; };
	bool			IsPlayingArcadeAsManhack(void) { return m_Local.m_bPlayingArcadeAsManhack; };

	float			WeaponProxyValueSlot01(void) { return m_Local.m_WeaponProxyValueSlot01_float; };
	float			WeaponProxyValueSlot02(void) { return m_Local.m_WeaponProxyValueSlot02_float; };
	float			WeaponProxyValueSlot03(void) { return m_Local.m_WeaponProxyValueSlot03_float; };
	float			WeaponProxyValueSlot04(void) { return m_Local.m_WeaponProxyValueSlot04_float; };
	float			WeaponProxyValueSlot05(void) { return m_Local.m_WeaponProxyValueSlot05_float; };
	float			WeaponProxyValueSlot06(void) { return m_Local.m_WeaponProxyValueSlot06_float; };
	float			WeaponProxyValueSlot07(void) { return m_Local.m_WeaponProxyValueSlot07_float; };
	float			WeaponProxyValueSlot08(void) { return m_Local.m_WeaponProxyValueSlot08_float; };
#endif	// DI end
	...
	virtual ShadowType_t		ShadowCastType() { return SHADOWS_NONE; } // DI CHANGED
...
#ifdef DARKINTERVAL
	bool				IsParalyzed(void) { return m_Local.m_bParalyzed; }
	bool				IsLocatorVisible(void) { return m_Local.m_bLocatorVisible; }
	bool				IsSuitlessHUDVisible(void) { return m_Local.m_bSuitlessHUDVisible && !m_Local.m_bPlayingArcade && !m_Local.m_bPlayingArcadeAsManhack; }
#endif
	...
	bool					ShouldAnnounceAchievement( void ){ return m_flNextAchievementAnnounceTime < CURTIME; }
