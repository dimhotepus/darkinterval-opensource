...
#ifndef DARKINTERVAL // this is the fix for the flickering sun under crosshair.
...
void CGlowOverlay::UpdateGlowObstruction( const Vector &vToGlow, bool bCacheFullSceneState )
{
...
#ifdef DARKINTERVAL // this is the fix for the flickering sun under crosshair.
	...
	if ( bFade )
	{
		...
		{
#ifdef DARKINTERVAL
			m_flGlowObstructionScale -= gpGlobals->frametime / 0.05f;
#else
