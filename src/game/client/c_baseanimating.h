...
#ifdef DARKINTERVAL	// glow
	bool				m_bGlowEnabled;
	bool				m_bOldGlowEnabled;
	CGlowObject			*m_pGlowEffect;
	float				m_fGlowColorRed;
	float				m_fGlowColorGreen;
	float				m_fGlowColorBlue;
...
#ifdef DARKINTERVAL
public:
	char m_nameplate_string[256]; // DI NEW: meshBuilder based text strings on models
#endif
};
