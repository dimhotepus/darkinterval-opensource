...
#ifdef DARKINTERVAL // a more detailed and clear system
	PMaterialHandle			m_Material_MuzzleFlash_Pistol[4];
	PMaterialHandle			m_Material_MuzzleFlash_Revolver[4];
	PMaterialHandle			m_Material_MuzzleFlash_SMG[4];
	PMaterialHandle			m_Material_MuzzleFlash_Shotgun[4];
	PMaterialHandle			m_Material_MuzzleFlash_Rifle[4];
	PMaterialHandle			m_Material_MuzzleFlash_Combine[2];

	PMaterialHandle			m_Material_MuzzleFlash_NPC_Pistol[4];
	PMaterialHandle			m_Material_MuzzleFlash_NPC_Revolver[4];
	PMaterialHandle			m_Material_MuzzleFlash_NPC_SMG[4];
	PMaterialHandle			m_Material_MuzzleFlash_NPC_Shotgun[4];
	PMaterialHandle			m_Material_MuzzleFlash_NPC_Rifle[4];
	PMaterialHandle			m_Material_MuzzleFlash_NPC_Combine[2];
#else
...
private:
	...
	// AR2
#ifdef DARKINTERVAL
	void					MuzzleFlash_Rifle_Player(ClientEntityHandle_t hEntity, int attachmentIndex);
	void					MuzzleFlash_Rifle_NPC(ClientEntityHandle_t hEntity, int attachmentIndex);
#else
	...
	// 357
#ifdef DARKINTERVAL
	void					MuzzleFlash_Revolver_Player( ClientEntityHandle_t hEntity, int attachmentIndex );
	void					MuzzleFlash_Revolver_NPC(ClientEntityHandle_t hEntity, int attachmentIndex);
#else
