...
#ifdef DARKINTERVAL // DI removes "damage accumulators" for sake of old code compatibility and because it doesn't benefit from this stuff.
...
#ifdef DARKINTERVAL
	virtual void					ParticleDecalTrace(trace_t *pTrace, char const *decalName);
#endif
