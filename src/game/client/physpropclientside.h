...
#ifdef DARKINTERVAL // customisable break and strain sounds.
					// custom break sound comes in handy when a prop can be static and not have
					// break sounds, because otherwise it'd have to be applied via surfaceprop/propdata.
					// strain sound is something planned originally for HL2 but unused. It plays
					// for props that have pressure delay.
