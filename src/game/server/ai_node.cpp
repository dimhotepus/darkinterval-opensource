...
//-----------------------------------------------------------------------------
#ifdef DARKINTERVAL
static ConVar npc_climb_offset("npc_climb_offset", "12.0f");
#endif
...
#ifdef DARKINTERVAL
		float  shift = npc_climb_offset.GetFloat();/*(0.5*NAI_Hull::Length(hull)) + (NODE_CLIMB_OFFSET)*/;
#else
