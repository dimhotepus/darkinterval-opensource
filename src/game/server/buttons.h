...
#ifdef DARKINTERVAL
	void InputDisableAutoReturn(inputdata_t &inputdata);
	void InputEnableAutoReturn(inputdata_t &inputdata);
#endif
...
#ifdef DARKINTERVAL
private:
	EHANDLE		m_rotationchild_entity; // attempt to fix bad case of parenting... didn't go far, I think
#endif
protected:
