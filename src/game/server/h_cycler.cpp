//========================================================================//
//
// Purpose: The Half-life Cycler NPCs
...
#ifdef DARKINTERVAL
	DEFINE_KEYFIELD( m_cycle_on_damage_bool, FIELD_BOOLEAN, "cycleOnDamage"),
	DEFINE_KEYFIELD( m_random_start_cycle_bool, FIELD_BOOLEAN, "randomStartCycle"),
#endif
	// Inputs
...
public:
	...
	{
#ifdef DARKINTERVAL
		m_flPlaybackRate = RandomFloat(0.98, 1.02); // DI change for soldiers parade
#endif
...
bool CWeaponCycler::Deploy( )
{
	...
	if (pOwner)
	{
		pOwner->m_flNextAttack = CURTIME + 1.0;
		SendWeaponAnim( 0 );
		m_iClip1 = 0;
		m_iClip2 = 0;
		return true;
...
bool CWeaponCycler::Holster( CBaseCombatWeapon *pSwitchingTo )
{
	...
	if (pOwner)
	{
		pOwner->m_flNextAttack = CURTIME + 0.5;
	}
...
void CWreckage::Think( void )
{
	...
	if (m_flDieTime)
	{
		if (m_flDieTime < CURTIME)
		{
			UTIL_Remove( this );
			return;
		}
		else if (random->RandomFloat( 0, m_flDieTime - m_flStartTime ) > m_flDieTime - CURTIME)
		{
			return;
		}
	}
