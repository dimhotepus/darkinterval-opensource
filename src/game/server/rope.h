...
#ifdef DARKINTERVAL
	void InputEnableWindForces(inputdata_t &inputdata);
	void InputDisableWindForces(inputdata_t &inputdata);
#endif
public:
...
#ifdef DARKINTERVAL
	CNetworkVar(bool, m_bEnableRopeNodeSprites); // used for ch05 hydra ropes, for example
#endif
