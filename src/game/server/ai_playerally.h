...
public:
	...
	float		GetTimePlayerStaring()		{ return ( m_flTimePlayerStartStare != 0 ) ? CURTIME - m_flTimePlayerStartStare : 0; }
	...
	void			AnswerQuestion( /*CAI_PlayerAlly*/ CBaseEntity *pQuestioner, int iQARandomNum, bool bAnsweringHello );
