...
#ifdef DARKINTERVAL	// DI CHANGE: this is broken? It throws null pMaterial in debug mode.
	// Since there's generally only two crack materials used in content right now, 
	// just hardcode its precache.
	PrecacheMaterial("glass/glasswindowbreak070b");
	PrecacheMaterial("tile/tilebreak001c");
#else
