...
#ifdef DARKINTERVAL
	COutputEvent	m_OnPhysGunLaunched;
#endif
...
#ifdef DARKINTERVAL
	COutputEvent	m_OnMagnetAttachPassEntity; // DI NEW - same as OnAttach, but passes along the attached entity as the activator
	COutputEvent	m_OnMagnetDetachPassEntity; // DI NEW - same as OnDetach, but passes along the attached entity as the activator
#endif
	// Keys
	float			m_massScale;
	string_t		m_iszOverrideScript;
