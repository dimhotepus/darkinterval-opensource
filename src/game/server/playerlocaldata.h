...
public:
	...
	CNetworkVar(bool, m_bWearingLongJump);
	CNetworkVar(bool, m_bParalyzed);
	CNetworkVar(bool, m_bPlayingArcade);
	CNetworkVar(bool, m_bPlayingArcadeAsManhack);
	CNetworkVar(bool, m_bLocatorVisible);
	CNetworkVar(bool, m_bSuitlessHUDVisible);
	CNetworkVar(float, m_WeaponProxyValueSlot01_float);
	CNetworkVar(float, m_WeaponProxyValueSlot02_float);
	CNetworkVar(float, m_WeaponProxyValueSlot03_float);
	CNetworkVar(float, m_WeaponProxyValueSlot04_float);
	CNetworkVar(float, m_WeaponProxyValueSlot05_float);
	CNetworkVar(float, m_WeaponProxyValueSlot06_float);
	CNetworkVar(float, m_WeaponProxyValueSlot07_float);
	CNetworkVar(float, m_WeaponProxyValueSlot08_float);
	bool m_suppressing_weapons_bool;
#endif
	// 3d skybox
