...
#define SF_SCRIPT_NO_COMPLAINTS			2048	// doesn't cry if it can't find anything
...
#ifdef DARKINTERVAL // more outputs for convenience
	COutputEvent m_OnStartEntryAnimation;
	COutputEvent m_OnEndEntryAnimation;
	COutputEvent m_OnEndActionAnimation;
#endif
