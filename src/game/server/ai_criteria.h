...
struct AI_ResponseParams
{
...
#ifdef DARKINTERVAL // new flag so spoken concepts can trigger the radio hud
		RG_SHOWRADUIOHUD =		(1<<9),
#endif
	};
	...
	AI_ResponseParams()
	{
		...
		predelay.range = 0;
#ifdef DARKINTERVAL
		showradiohud.start = 0;
		showradiohud.range = 0;
#endif
	}
...
#ifdef DARKINTERVAL
	responseparams_interval_t	showradiohud;
#endif
};
#pragma pack()
...
#ifdef DARKINTERVAL
	float			GetRadioHUDStart() const;
	float			GetRadioHUDLength() const;
#endif
