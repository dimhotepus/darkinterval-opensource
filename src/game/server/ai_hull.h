...
#ifdef DARKINTERVAL
	bits_HOUNDEYE_HULL			=	0x00000400,
	bits_CRABSYNTH_HULL			=	0x00000800,
	bits_ADVISOR_HULL			=	0x00001000,
	bits_CREMATOR_HULL			=	0x00002000,
	bits_GLIDERSYNTH_HULL		=	0x00004000,
	bits_WATERSQUID_HULL		=	0x00008000,
	bits_HOPPER_HULL			=	0x00010000,
#endif
