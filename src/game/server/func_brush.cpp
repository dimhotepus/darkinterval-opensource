...
#include "func_brush.h" // DI renames it from modelentities to make easier to find
...
#ifdef DARKINTERVAL
	DEFINE_KEYFIELD( m_bBlocksLOS, FIELD_BOOLEAN, "blockslos"),
#endif
