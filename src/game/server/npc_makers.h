...
// DI NEW: add options to make this maker spawn things on selected difficulties
#define SF_NPCMAKER_DIFFICULTY_NOT_EASY				1<<16
#define SF_NPCMAKER_DIFFICULTY_NOT_MEDIUM			1<<17
#define SF_NPCMAKER_DIFFICULTY_NOT_HARD				1<<18

#define SF_NPCMAKER_SERVERRAGDOLL	1<<19
//=========================================================
//=========================================================
...
public:
	...
	int m_iszNPCSkin;					// skin to set to spawned NPCs
...
protected:
	...
	string_t m_iszOptionalModelName;
