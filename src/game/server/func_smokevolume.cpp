...
public:
	...
	void Spawn();
	void Activate( void );
#ifdef DARKINTERVAL // for convenience
...
#ifdef DARKINTERVAL // for convenience
int CFuncSmokeVolume::DrawDebugTextOverlays(void)
{
	...
	{
		char tempstr[512];
		Q_snprintf(tempstr, sizeof(tempstr), "Color 1: %i %i %i", m_Color1.m_Value.r, m_Color1.m_Value.g, m_Color1.m_Value.b);
		EntityText(nOffset, tempstr, 0);
		nOffset++;
		Q_snprintf(tempstr, sizeof(tempstr), "Color 2: %i %i %i", m_Color2.m_Value.r, m_Color2.m_Value.g, m_Color2.m_Value.b);
		EntityText(nOffset, tempstr, 0);
		nOffset++;
		Q_snprintf(tempstr, sizeof(tempstr), "Density: %.1f", m_Density.m_Value);
		EntityText(nOffset, tempstr, 0);
		nOffset++;
	}
