...
public:
	...
	virtual void			ExpireCurrentRandomLookTarget() { m_flNextRandomLookTime = CURTIME - 0.1f; }
...
class CAI_BaseActorNoBlend : public CAI_ExpresserHost<CAI_BaseHumanoidNoBlend>
{
	DECLARE_CLASS(CAI_BaseActorNoBlend, CAI_ExpresserHost<CAI_BaseHumanoidNoBlend>);
