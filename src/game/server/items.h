...
#ifdef DARKINTERVAL
#define SIZE_AMMO_BUCKSHOT			5 // strip
#define SIZE_AMMO_BUCKSHOT_LARGE	20 // box
#else
...
#ifdef DARKINTERVAL
#define SIZE_AMMO_OICW_MAG			20
#define SIZE_AMMO_OICW_BOX			SIZE_AMMO_OICW_MAG * 4
#define SIZE_AMMO_TAU				25
#define SIZE_AMMO_TAU_BOX			100
#endif
...
#ifdef DARKINTERVAL
	virtual bool ConsumedInstantlyByTouch(void) { return true; } // some things like the healthkits aren't consumed but have multiple "charges"/reserve
#endif
...
#ifdef DARKINTERVAL // useful for things that shouldn't be pickupable until uncovering them, things that shouldn't be shaken by explosions, etc
	virtual void InputDisableMotion(inputdata_t &data);
	virtual void InputEnableMotion(inputdata_t &data);
#endif
