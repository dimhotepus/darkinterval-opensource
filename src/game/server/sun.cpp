...
public:
	...
	float	m_flPitch;
	float	m_flYaw;
#ifdef DARKINTERVAL // unfinished implementation of secondary sun
	float	m_flPitchSec;
	float	m_flYawSec;
#endif
...
#ifdef DARKINTERVAL // unfinished implementation of secondary sun
//	CNetworkVar(int, m_nSizeSec);		// Size of the secondary core image
//	CNetworkVar(int, m_nOverlaySizeSec); // Size for the secondary glow overlay
//	CNetworkVar(color32, m_clrOverlaySec);
//	CNetworkVar(int, m_nMaterialSec);
//	CNetworkVar(int, m_nOverlayMaterialSec);
#endif
};
...
#ifdef DARKINTERVAL // unfinished implementation of secondary sun
//	SendPropInt(SENDINFO(m_clrOverlaySec), 32, SPROP_UNSIGNED, SendProxy_Color32ToInt),
#endif
