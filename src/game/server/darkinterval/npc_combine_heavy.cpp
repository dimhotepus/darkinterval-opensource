//========= Dark Interval, 2021. ==============================================//
//
// Purpose: The heavy trooper - armour pads takes all the damage
//
//=============================================================================//
...
LINK_ENTITY_TO_CLASS(npc_combine_heavy, CNPC_Combine_Armored);
...
void CNPC_Combine_Armored::Precache()
{
	if (!GetModelName())
	{
		SetModelName(MAKE_STRING("models/_Monsters/Combine/Combine_Recon.mdl"));
	}
...
void CNPC_Combine_Armored::SpawnArmorPieces(void)
{
	...
	{
		{ "attach_L_Thigh_armor",		"models/props_junk/cardboard_box004a.mdl"},//"models/combine_armor.mdl" },
		{ "attach_L_UpperArm_armor",	"models/props_junk/cardboard_box004a.mdl" },//"models/combine_armor.mdl" },
		{ "attach_R_Thigh_armor",		"models/props_junk/cardboard_box004a.mdl" },//"models/combine_armor.mdl" },
		{ "attach_R_UpperArm_armor",	"models/props_junk/cardboard_box004a.mdl" },//"models/combine_armor.mdl" },
		{ "attach_chest_armor",			"models/props_junk/cardboard_box004a.mdl" },//"models/combine_armor_chest.mdl" },
	};
