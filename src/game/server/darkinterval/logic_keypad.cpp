...
LINK_ENTITY_TO_CLASS(logic_keypad, CLogicKeypad);

BEGIN_DATADESC(CLogicKeypad)
...
// Purpose: 
//-----------------------------------------------------------------------------
void CLogicKeypad::Precache(void)
{
}
...
//-----------------------------------------------------------------------------
bool CLogicKeypad::KeyValue(const char *szKeyName, const char *szValue)
{
...
void CLogicKeypad::Enable(inputdata_t &inputdata)
{
...
//-----------------------------------------------------------------------------
void CLogicKeypad::FireTarget(void)
{
...
//-----------------------------------------------------------------------------
void CLogicKeypad::WrongCode(void)
{
