...
ConVar r_lights_fade_rate("r_lights_fade_rate", "0", 0, "If >0, overrides refresh rate of FadeToPattern think in light, light_spot, light_environment.");
#endif
...
#ifdef DARKINTERVAL
	DEFINE_KEYFIELD( m_fadepattern_rate_float, FIELD_FLOAT, "fadepatternrate"),
#endif
	// Fuctions
...
#ifdef DARKINTERVAL
		SetNextThink(CURTIME + ( r_lights_fade_rate.GetFloat() > 0.0f ? r_lights_fade_rate.GetFloat() : m_fadepattern_rate_float ));
#else
