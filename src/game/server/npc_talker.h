...
//=========================================================
#ifdef DARKINTERVAL
#define TLK_CFRIENDS		5 // adds Kleiner
#else
...
#ifdef DARKINTERVAL
	CBaseEntity		*FindNamedEntity(const char *pszName, IEntityFindFilter *pFilter = NULL); // returns who we're talking to for vcd's
#endif
