//========================================================================//
//
// Purpose: Implements the vgui based slideshow display.
//
//=============================================================================//
...
void CSlideshowDisplay::BuildSlideShowImagesList(void)
{
	...
	Q_snprintf(szDirectory, sizeof(szDirectory), "materials/%s/*.vmt", m_szSlideshowDirectory.Get());
	...
	while (szMatFileName[0])
	{
		...
		Q_snprintf(szFullFileName, sizeof(szFullFileName), "materials/%s/%s", m_szSlideshowDirectory.Get(), szMatFileName);
