...
#ifdef DARKINTERVAL
	void InputChangeVehicleScript(inputdata_t &inputdata);
#endif
	DECLARE_DATADESC();
...
#ifdef DARKINTERVAL
	void	InputDisableMovement(inputdata_t &inputdata); // work as TurnOff, but without disabling guns
	void	InputEnableMovement(inputdata_t &inputdata); // work as TurnOn after using TurnOff
#endif
	// Locals
