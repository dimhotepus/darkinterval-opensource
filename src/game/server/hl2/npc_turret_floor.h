...
#ifdef DARKINTERVAL
//#include "physics_bone_follower.h" // used to be used for retro tripod turrets, but not used right now
#endif
//Turret states
enum turretState_e
{
...
#ifdef DARKINTERVAL
	virtual bool	IsCombineTurret(void);
#endif
...
#ifndef DARKINTERVAL // unused in DI, there's no rebel Combine turrets
	int		m_iKeySkin;
#endif
