...
public:
	...
	bool			CanBeRescuedFromBarnacle(void){	return true;} // prototyping barnacle rescue
	...
	void			InputEnableFollow(inputdata_t &data);
	void			InputDisableFollow(inputdata_t &data);
	void			InputStartFollow(inputdata_t &data);
	void			InputStopFollow(inputdata_t &data);
...
private:
	...
	float			m_next_pain_time;
	float			m_next_line_fire_time;
//	bool			m_vort_eaten_by_barnacle_bool;
	bool			m_vort_charging_enabled_bool;
	bool			m_vort_charging_forced_bool;
	bool			m_vort_can_follow_bool;
	bool			m_extracting_bugbait_bool;
	bool			m_stop_looping_sounds_bool;
