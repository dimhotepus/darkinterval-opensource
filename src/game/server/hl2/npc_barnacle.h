...
// how many seconds after pulling prey in to gib them. 
...
//-----------------------------------------------------------------------------
// Purpose: This is the entity we place at the top & bottom
// of the tongue to create a vphysics spring
//-----------------------------------------------------------------------------
...
public:
	...
	virtual void Spawn(void); // DI todo - do these need to be virtual?
...
#ifdef DARKINTERVAL
	float m_pain_tongue_raise_float; // keep our tongue raised if we were recently wounded and forced to drop prey
#endif
	static const char	*m_szGibNames[ NUM_BARNACLE_GIBS ];
#ifdef DARKINTERVAL // DI barnacles spawn extra gibs - skeletal remains
	static const char *m_szGibNamesLargeTorso[ NUM_BARNACLE_GIBS - 1 ];
	static const char *m_szGibNamesLargeLimbs[ NUM_BARNACLE_GIBS ];
	static const char *m_szGibNamesRare[ NUM_BARNACLE_GIBS ];
#endif
