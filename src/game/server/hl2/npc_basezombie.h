...
enum 
{
	...
	TASK_ZOMBIE_SLUMP_WAIT,
	TASK_ZOMBIE_SLUMP_RISE,
...
#ifdef DARKINTERVAL // more convenient method than scripted sequences or actbusy
	void InputEnterSlumpMode(inputdata_t &inputdata);
	void InputExitSlumpMode(inputdata_t &inputdata);
#endif
...
protected:
...
#ifdef DARKINTERVAL // DI todo - is this needed anymore? 
	CHandle<CRagdollProp>	m_live_ragdoll_handle;
#endif
	...
	static int ACT_ZOMBIE_SLUMP_A;
	static int ACT_ZOMBIE_SLUMP_A_RISE;
	static int ACT_ZOMBIE_SLUMP_B;
	static int ACT_ZOMBIE_SLUMP_B_RISE;
...
private:
	...
	int m_zombie_starts_slumped_int;
#endif
};
