...
//
// Purpose: 
// DI todo - make torso, legs and headcrab models into Hammer keyvalues, 
// and use the new NPC script system
// $NoKeywords: $
//=============================================================================//
...
{
#ifdef DARKINTERVAL
	PrecacheModel("models/_Monsters/Zombies/fast.mdl");
	PrecacheModel("models/_Monsters/Zombies/Fast_torso.mdl");
	PrecacheModel("models/_Monsters/Zombies/fast_legs.mdl" );
#else
...
{
	if ( m_flNextMeleeAttack > CURTIME + 1 )
	{
		// Allow melee attacks again.
		m_flNextMeleeAttack = CURTIME + 0.5;
	}
...
void CFastZombie::PrescheduleThink( void )
{
	...
	if( GetGroundEntity() && GetGroundEntity()->Classify() == CLASS_HEADCRAB )
	{
 	...
 	if( m_pMoanSound && CURTIME > m_flTimeUpdateSound )
	{
		...
		m_flTimeUpdateSound = CURTIME + FASTZOMBIE_SOUND_UPDATE_FREQ;
	}
...
{
#ifdef DARKINTERVAL
	return "models/_Monsters/Xen/headcrab_fast.mdl";
#else
...
void CFastZombie::SetZombieModel( void )
{
	...
	{
#ifdef DARKINTERVAL
		SetModel( "models/_Monsters/Zombies/fast_torso.mdl" );
#else
	...
	{
#ifdef DARKINTERVAL
		SetModel("models/_Monsters/Zombies/fast.mdl");
#else
...
{
#ifdef DARKINTERVAL
	return "models/_Monsters/Zombies/fast_legs.mdl";
#else
	return s_pLegsModel; // why bother with a static const char?
#endif
}
...
{
#ifdef DARKINTERVAL
	return "models/_Monsters/Zombies/fast_torso.mdl";
#else
...
int CFastZombie::MeleeAttack1Conditions( float flDot, float flDist )
{
	...
	if( CURTIME < m_flNextMeleeAttack )
	{
		return COND_NONE;
	}
...
void CFastZombie::StartTask( const Task_t *pTask )
{
	...
	case TASK_RANGE_ATTACK1:
		...
		m_flNextMeleeAttack = CURTIME + 60;
