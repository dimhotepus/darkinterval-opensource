...
protected:
	...
	bool			IsReadinessLocked() { return CURTIME < m_flReadinessLockedUntil; }
...
public:
	...
	//---------------------------------
#ifdef DARKINTERVAL
	void			InputStartIgnoringPlayerPush(inputdata_t &inputdata);
	void			InputStopIgnoringPlayerPush(inputdata_t &inputdata);
#endif
