...
void CFunc_Dust::Spawn()
{
	...
	color32 clr = { (byte)m_Color.m_Value.r, (byte)m_Color.m_Value.g, (byte)m_Color.m_Value.b, (byte)m_iAlpha };
	m_Color.Set( clr );
...
{
#ifdef DARKINTERVAL // higher res and consistent with other volumetric entities
