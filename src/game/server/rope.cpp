...
#ifdef DARKINTERVAL
	SendPropBool(SENDINFO(m_bEnableRopeNodeSprites)),
#endif
...
#ifdef DARKINTERVAL
	DEFINE_KEYFIELD( m_bEnableRopeNodeSprites, FIELD_BOOLEAN, "EnableRopeSprites"),
#endif
...
#ifdef DARKINTERVAL
	DEFINE_INPUTFUNC(FIELD_VOID, "EnableWindForces", InputBreak),
	DEFINE_INPUTFUNC(FIELD_VOID, "DisableWindForces", InputBreak),
#endif
END_DATADESC()
...
#ifdef DARKINTERVAL
//-----------------------------------------------------------------------------
// Purpose: Enables wind forces on this rope
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CRopeKeyframe::InputEnableWindForces(inputdata_t &inputdata)
{
	m_RopeFlags &= ROPE_NO_WIND;
}

//-----------------------------------------------------------------------------
// Purpose: Disnables wind forces on this rope
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CRopeKeyframe::InputDisableWindForces(inputdata_t &inputdata)
{
	m_RopeFlags |= ROPE_NO_WIND;
}
#endif
