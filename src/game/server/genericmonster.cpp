...
#ifdef DARKINTERVAL
class CGenericNPCCluster : public CAI_BaseNPC
{
public:
	DECLARE_CLASS(CGenericNPCCluster, CAI_BaseNPC);
...
LINK_ENTITY_TO_CLASS(monster_generic_cluster, CGenericNPCCluster);
#endif
//=========================================================
...
#ifdef DARKINTERVAL
void CGenericNPC::NPCThink(void)
{
	char szMapName[256];
	...
	if (!Q_strnicmp(szMapName, "ch02_arcadeexterior", 19)) // optimisation for the Combine parade // DI todo - still necessary?
	{
