...
void CEnvSpark::Spawn(void)
{
	...
	SetNextThink( CURTIME + 0.1 + random->RandomFloat( 0, 1.5 ) );
...
#ifdef DARKINTERVAL // oversight, not having them precached meant inaudible medium/large sparks
...
{
	SetNextThink( CURTIME + 0.1 + random->RandomFloat(0, m_flDelay) );
