...
#ifdef DARKINTERVAL // the assert is not that helpful, happens routinely
	CAI_Node*		GetNode( int id, bool bHandleError = false )
#else
...
#ifdef DARKINTERVAL
	bits_debugOverlaySwimConnections =  0x00000400,		// show swim connections // DI NEW - water nodes
#endif
